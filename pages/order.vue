                    ...
                    .step(v-if="currentStep === 3")  
                        ...
                        .variant(@click="delVariant = 'Самовывоз'; changeDelPrice(0)" :class="{active: delVariant === 'Самовывоз' }")
                            .variant-title 
                                |Самовывоз
                                br
                                span(style="font-weight: normal; font-size: 13px") (по Москве)
    ...
    export default{
      ...
      methods: {
        ...
        submitForm() {
          ...
          axios.post('https://api.telegram.org/bot6022000766:AAGtUNYgj7WQ9pFL4kqZMLUSItiR65rz7vc/sendMessage', {
            chat_id: '-1001845199900',
            parse_mode: 'html',
            text: message
          }).then(
